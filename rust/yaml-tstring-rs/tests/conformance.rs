...
use tstring_yaml::{YamlProfile, parse_template_with_profile};
...
#[test]
fn yaml_conformance_manifest_cases_match_parser_expectations() {
    for case in load_cases("1.2.2") {
        ...
        let parsed = parse_template_with_profile(&template, YamlProfile::V1_2_2);
...
fn conformance_root() -> PathBuf {
    repo_root().join("conformance/yaml")
}
